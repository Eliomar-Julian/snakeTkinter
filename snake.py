...
SNAKE = []
COORD = []
TITLE = "Snake Tk - Eliomar Julian"
DIR_WIN = path.join(path.dirname(path.abspath(__file__)), "logo.ico")
DIR_UNI = path.join(path.dirname(path.abspath(__file__)), "logo.png")
...
class Jogo:
    def __init__(self):
        ...
        try:
            self.window.iconbitmap(DIR_WIN)
        except Exception as error:
            print(error)
            self.window.iconphoto(True, PhotoImage(file=DIR_UNI))
